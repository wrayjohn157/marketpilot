...
class CredentialManager:
    ...
    CREDENTIAL_CONFIGS = {
        ...
        CredentialType.OPENAI: CredentialConfig(
            name="openai", required_keys=["OPENAI_API_KEY"], env_prefix="OPENAI_"
        ),
    ...
    def get_credentials(
        self, cred_type: CredentialType, profile: str = "default"
    ) -> Dict[str, Any]:
    ...
    def _load_credentials(
        self, cred_type: CredentialType, profile: str
    ) -> Dict[str, Any]:
    ...
    def _validate_credentials(
        self, cred_type: CredentialType, credentials: Dict[str, Any]
    ) -> None:
