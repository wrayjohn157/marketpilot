...
class ConfigMigrationTool:
    ...
    def _build_migration_map(self) -> Dict[str, str]:
        ...
        return {
            ...
            r'BASE_DIR / "data" / "snapshots"': 'get_path("snapshots")',
            r'BASE_DIR / "output" / "fork_history"': 'get_path("fork_history")',
            r'BASE_DIR / "dashboard_backend" / "btc_logs"': 'get_path("btc_logs")',
            r'BASE_DIR / "live" / "logs"': 'get_path("live_logs")',
            r'BASE_DIR / "live" / "models"': 'get_path("models")',
