...
class RedisMigrationTool:
    ...
    def _build_migration_map(self) -> Dict[str, str]:
        ...
        return {
            ...
            r'"indicators:BTC:1h:latest_close"': '"indicators:BTC:1h:latest_close"',
            r'"indicators:BTC:1h:EMA50"': '"indicators:BTC:1h:EMA50"',
            r'"indicators:BTC:15m:RSI14"': '"indicators:BTC:15m:RSI14"',
            r'"indicators:BTC:1h:ADX14"': '"indicators:BTC:1h:ADX14"',
            r'"cache:btc_condition"': '"cache:btc_condition"',
            r'"counters:last_scan_vol"': '"counters:last_scan_vol"',
            r'"counters:tech_filter_count_in"': '"counters:tech_filter_count_in"',
            r'"counters:tech_filter_count_out"': '"counters:tech_filter_count_out"',
            r'"counters:volume_filter_count"': '"counters:volume_filter_count"',
            r'"queues:final_trades"': '"queues:final_trades"',
            r'"sessions:sent_trades"': '"sessions:sent_trades"',
            r'"queues:volume_passed_tokens"': '"queues:volume_passed_tokens"',
            r'"queues:fork_rrr_passed"': '"queues:fork_rrr_passed"',
            r'"queues:fork_score_approved"': '"queues:fork_score_approved"',
    ...
    def _needs_redis_manager_import(self, content: str) -> bool:
        ...
        return (
            ...
            or "RedisKeyManager." in content
            or "store_indicators(" in content
            or "get_indicators(" in content
            or "store_trade_data(" in content
            or "get_trade_data(" in content
            or "set_counter(" in content
            or "get_counter(" in content
            or "set_cache(" in content
            or "get_cache(" in content
