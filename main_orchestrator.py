...
class MainOrchestrator:
    ...
    def _initialize_managers(self):
        ...
        try:
            ...
            if self.config.get("run_ml_training", False) or self.config.get("run_ml_inference", False):
    ...
    async def run_main_cycle(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.redis_manager.set_counter("main_cycle_timestamp", int(end_time.timestamp()))
    ...
    def _save_results(self, results: Dict[str, Any]) -> None:
        ...
        try:
            results_file = get_path("live_logs") / f"main_cycle_{datetime.utcnow().strftime('%Y%m%d_%H%M%S')}.json"
