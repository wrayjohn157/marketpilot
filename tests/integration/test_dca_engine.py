...
class TestDCAEngineIntegration:
    ...
    def test_run_with_trades(
        self, mock_should_dca, mock_health, mock_zombie, mock_get_trades, dca_engine
    ):
    ...
    def test_run_with_dca_signal(
        ...
        mock_zombie.return_value = False
        mock_health.return_value = {"should_exit": False}
        mock_should_dca.return_value = {"should_dca": True, "volume": 15.0, "step": 1}
    ...
    @patch("dca.core.dca_engine.should_dca")
    def test_process_dca_logic_no_indicators(
        self, mock_should_dca, mock_indicators, dca_engine
    ):
    ...
    @patch("dca.core.dca_engine.should_dca")
    @patch("dca.core.dca_engine.send_dca_signal")
    def test_process_dca_logic_should_dca(
        self, mock_send_signal, mock_should_dca, mock_indicators, dca_engine
    ):
        """Test DCA logic when DCA should be triggered."""
        trade = {"id": 12345, "pair": "USDT_BTC"}
        mock_indicators.return_value = {"macd_histogram": 0.02}
        mock_should_dca.return_value = {"should_dca": True, "volume": 20.0, "step": 2}
