...
def should_dca(trade: Any, config: Any, indicators: Any, btc_status: Any, entry_score: Any, current_score: Any, safu_score: Any, tp1_sim_pct: Any, recovery_odds: Any) -> Any:
# === BTC Filter ===
